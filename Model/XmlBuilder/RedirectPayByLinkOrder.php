...
EOD;
    ...
    /**
     * Add order line items to XML
     *
     * @param SimpleXMLElement $order
     */
    private function addOrderLineItemsXML($order)
    {
        $diffAmt = 0;
        $totalAmount = 0;
     ...
     */
    private function _addOrderLineItemElement(
        $parentElement,
        $reference,
        $name,
        $productType,
