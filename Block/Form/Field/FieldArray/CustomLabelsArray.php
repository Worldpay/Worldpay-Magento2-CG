...
use Sapient\Worldpay\Block\Form\Field\FieldArray\CustomLabelsFieldArray;

/**
 * Backend system config array field renderer
 *
 */
class CustomLabelsArray extends CustomLabelsFieldArray
{
    
    /**
     * @var string
     */
    protected $_template = 'Sapient_Worldpay::form/field/customlabelarray.phtml';
