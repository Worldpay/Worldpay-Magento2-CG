...
/**
 * Description of MultishippingId
 */
...
class MultishippingId extends Column
{
    /**
     * Worldpay payments
     *
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if ($isMultishipping) {
                    $multishippingId = $worldpaypayment->getWorldpayOrderId();
                    $item[$this->getData('name')] = strtoupper($multishippingId);
                }
            }
        }
