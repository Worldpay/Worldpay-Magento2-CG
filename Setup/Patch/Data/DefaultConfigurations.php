...
class DefaultConfigurations implements DataPatchInterface
{
    ...
    public function saveExtendedResponseCode()
    {
        ...
        $responseValue  = [
            ...
            $index . '_31'  => [
                "wpay_code"  => "62",
                "wpay_desc"  => "Restricted card OR Restricted card (in Country Exclusion table)",
                "custom_msg" => "",
            ],
            $index . '_32'  => [
                "wpay_code"  => "63",
            ...
            $index . '_46'  => [
                "wpay_code"  => "85",
                "wpay_desc"  => "Not declined. Valid for AVS only, balance Inq OR No reason to decline a request",
                "custom_msg" => "",
            ],
            $index . '_47'  => [
                "wpay_code"  => "86",
            ...
            $index . '_49'  => [
                "wpay_code"  => "89",
                "wpay_desc"  => "Unacceptable PIN - Transaction Declined - Retry OR Ineligible to receive",
                "custom_msg" => "",
            ],
            $index . '_50'  => [
                "wpay_code"  => "91",
                "wpay_desc"  => "Authorization System or issuer system inoperative OR Authorization System or issuer system inop",
                "custom_msg" => "",
            ],
            $index . '_51'  => [
                "wpay_code"  => "92",
                "wpay_desc"  => "Unable to route transaction OR Destination cannot be found for routing",
                "custom_msg" => "",
            ],
            $index . '_52'  => [
                "wpay_code"  => "93",
            ...
            $index . '_59'  => [
                "wpay_code"  => "442",
                "wpay_desc"  => "Acquirer Institution Identification Code in the request message is not registered at CAFIS",
                "custom_msg" => "",
            ],
            $index . '_60'  => [
                "wpay_code"  => "443",
            ...
            $index . '_69'  => [
                "wpay_code"  => "452",
                "wpay_desc"  => "CAFIS detected a timeout when it sent the message to the acquirer. Try again",
                "custom_msg" => "",
            ],
            $index . '_70'  => [
                "wpay_code"  => "453",
            ...
            $index . '_85'  => [
                "wpay_code"  => "584",
                "wpay_desc"  => "The amount exceeds the limit for the day. (insufficient funds)",
                "custom_msg" => "",
            ],
            $index . '_86'  => [
                "wpay_code"  => "586",
            ...
            $index . '_89'  => [
                "wpay_code"  => "589",
                "wpay_desc"  => "Message element Primary Account Number value is invalid (MOD 10 check failed)",
                "custom_msg" => "",
            ],
            $index . '_90'  => [
                "wpay_code"  => "590",
            ...
            $index . '_99'  => [
                "wpay_code"  => "600",
                "wpay_desc"  => "Message elements Service Code, Business Code and Message Code value is invalid",
                "custom_msg" => "",
            ],
            $index . '_100' => [
                "wpay_code"  => "601",
            ...
            $index . '_109' => [
                "wpay_code"  => "610",
                "wpay_desc"  => "The request message for which a transaction is not supported is received",
                "custom_msg" => "",
            ],
            $index . '_110' => [
                "wpay_code"  => "611",
                "wpay_desc"  => "The request message from a centre which has not made the contact.",
                "custom_msg" => "",
            ],
            $index . '_111' => [
                "wpay_code"  => "622",
            ...
            $index . '_118' => [
                "wpay_code"  => "629",
                "wpay_desc"  => "Message element Card Acceptor Terminal Identification setting error",
                "custom_msg" => "",
            ],
            $index . '_119' => [
                "wpay_code"  => "630",
            ...
            $index . '_121' => [
                "wpay_code"  => "632",
                "wpay_desc"  => "Message element Processor Authentication Key Index setting error",
                "custom_msg" => "",
            ],
            $index . '_122' => [
                "wpay_code"  => "633",
            ...
            $index . '_124' => [
                "wpay_code"  => "635",
                "wpay_desc"  => "Message element Acquirer Institution Identification Code setting error",
                "custom_msg" => "",
            ],
            $index . '_125' => [
                "wpay_code"  => "636",
            ...
            $index . '_135' => [
                "wpay_code"  => "646",
                "wpay_desc"  => "Message element Original Terminal Processing Serial Number setting error",
                "custom_msg" => "",
            ],
            $index . '_136' => [
                "wpay_code"  => "647",
            ...
            $index . '_137' => [
                "wpay_code"  => "659",
                "wpay_desc"  => "Message element Original Processor Transaction Date-Time setting error",
                "custom_msg" => "",
            ],
            $index . '_138' => [
                "wpay_code"  => "660",
            ...
            $index . '_139' => [
                "wpay_code"  => "661",
                "wpay_desc"  => "Message element Terminal Processing Serial Number setting error",
                "custom_msg" => "",
            ],
            $index . '_140' => [
                "wpay_code"  => "662",
            ...
            $index . '_143' => [
                "wpay_code"  => "665",
                "wpay_desc"  => "Message element Accountholder Authentication Value setting error",
                "custom_msg" => "",
            ],
            $index . '_144' => [
                "wpay_code"  => "666",
            ...
            $index . '_149' => [
                "wpay_code"  => "671",
                "wpay_desc"  => "Combination of message elements Service Code and Message Code setting is incorrect",
                "custom_msg" => "",
            ],
            $index . '_150' => [
                "wpay_code"  => "672",
            ...
            $index . '_151' => [
                "wpay_code"  => "673",
                "wpay_desc"  => "There is more than one original transaction to reverse. Unable to reverse the transaction",
                "custom_msg" => "",
            ],
            $index . '_152' => [
                "wpay_code"  => "674",
                "wpay_desc"  => "Combination of message elements Processor Code and Merchant Code setting is incorrect",
                "custom_msg" => "",
            ],
            $index . '_153' => [
                "wpay_code"  => "675",
    ...
    public function saveCCLabels()
    {
        ...
        $exceptionValues = [
            $index . '_0'  => [
                "exception_code"            => "CCAM0",
                "exception_messages"        => "The card number entered is invalid.",
                "exception_module_messages" => "",
            ],
            $index . '_1'  => [
                "exception_code"            => "CCAM1",
                "exception_messages"        => "Card number should contain between 12 and 20 numeric characters.",
                "exception_module_messages" => "",
            ],
            $index . '_2'  => [
                "exception_code"            => "CCAM2",
                "exception_messages"        => "This card number cannot be used to place 3DS2 order now, please go " .
                    "and update this from My account first.",
                "exception_module_messages" => "",
            ],
            $index . '_3'  => [
                "exception_code"            => "CCAM3",
                "exception_messages"        => "Please, enter valid Card Verification Number",
                "exception_module_messages" => "",
            ],
            $index . '_4'  => [
                "exception_code"            => "CCAM4",
                "exception_messages"        => "Please, Save the card before placing subscription order",
                "exception_module_messages" => "",
            ],
            $index . '_5'  => [
                "exception_code"            => "CCAM5",
                "exception_messages"        => "Please, Verify the disclaimer! before saving  the card",
                "exception_module_messages" => "",
            ],
            $index . '_6'  => [
                "exception_code"            => "CCAM6",
                "exception_messages"        => "Please select one of the options",
                "exception_module_messages" => "",
            ],
            $index . '_7'  => [
                "exception_code"            => "CCAM7",
                "exception_messages"        => "Failed due to unrecoverable error",
                "exception_module_messages" => "",
            ],
            $index . '_8'  => [
                "exception_code"            => "CCAM8",
                "exception_messages"        => "3DS Failed",
                "exception_module_messages" => "",
            ],
            $index . '_9'  => [
                "exception_code"            => "CCAM9",
                "exception_messages"        => "Unfortunately the order could not be processed. "
                    . "Please contact us or try again later.",
                "exception_module_messages" => "",
            ],
            $index . '_10' => [
                "exception_code"            => "CCAM10",
                "exception_messages"        => "An error occurred",
                "exception_module_messages" => "",
            ],
            $index . '_11' => [
                "exception_code"            => "CCAM11",
                "exception_messages"        => "An error occurred on the server. Please try to place the order again.",
                "exception_module_messages" => "",
            ],
            $index . '_12' => [
                "exception_code"            => "CCAM12",
                "exception_messages"        => "3DS2 services are disabled, please contact system administrator.",
                "exception_module_messages" => "",
            ],
            $index . '_13' => [
                "exception_code"            => "CCAM13",
                "exception_messages"        => "Invalid Payment Type. Please Refresh and check again",
                "exception_module_messages" => "",
            ],
            $index . '_14' => [
                "exception_code"            => "CCAM14",
                "exception_messages"        => "WorldPay refund ERROR: Credit Memo does not match Order. Reference",
                "exception_module_messages" => "",
            ],
            $index . '_15' => [
                "exception_code"            => "CCAM15",
                "exception_messages"        => "Unfortunately the order could not be processed." .
                    " Please contact us or try again later",
                "exception_module_messages" => "",
            ],
            $index . '_16' => [
                "exception_code"            => "CCAM16",
                "exception_messages"        => "Duplicate Entry, This card number is already saved.",
                "exception_module_messages" => "",
            ],
            $index . '_17' => [
                "exception_code"            => "CCAM17",
                "exception_messages"        => "Order %s has been declined, please check your details and try again",
                "exception_module_messages" => "",
            ],
            $index . '_18' => [
                "exception_code"            => "CCAM18",
                "exception_messages"        => "An unexpected error occurred, Please try to place the order again",
                "exception_module_messages" => "",
            ],
            $index . '_19' => [
                "exception_code"            => "CCAM19",
                "exception_messages"        => "There appears to be an issue with your stored data," .
                    " please review in your account and update details as applicable.",
                "exception_module_messages" => "",
            ],
            $index . '_20' => [
                "exception_code"            => "CCAM20",
                "exception_messages"        => "CPF is 11 digits and CNPJ is 14 digits.",
                "exception_module_messages" => "",
            ],
            $index . '_21' => [
                "exception_code"            => "CCAM21",
                "exception_messages"        => "Only alphabet,number or space is allowed",
                "exception_module_messages" => "",
            ],
            $index . '_22' => [
                "exception_code"            => "CCAM22",
                "exception_messages"        => "You already seem to have this card number stored, " .
                    "If your card details have changed, you can update them via My Account -> Saved Card",
                "exception_module_messages" => "",
            ],
            $index . '_23' => [
                "exception_code"            => "CCAM23",
                "exception_messages"        => "Parse error with PaRes: Error parsing pARes",
                "exception_module_messages" => "",
            ],
            $index . '_24' => [
                "exception_code"            => "CCAM24",
                "exception_messages"        => "Invalid Configuration. Please Refresh and check again",
                "exception_module_messages" => "",
            ],
            $index . '_25' => [
                "exception_code"            => "CCAM25",
                "exception_messages"        => "Invalid Expiry Year. Please Refresh and check again",
                "exception_module_messages" => "",
            ],
            $index . '_26' => [
                "exception_code"            => "CCAM26",
                "exception_messages"        => "Invalid Expiry Month. Please Refresh and check again",
                "exception_module_messages" => "",
            ],
            $index . '_27' => [
                "exception_code"            => "CCAM27",
                "exception_messages"        => "Invalid Card Number. Please Refresh and check again",
                "exception_module_messages" => "",
            ],
            $index . '_28' => [
                "exception_code"            => "CCAM28",
                "exception_messages"        => "Invalid Card Holder Name.Please Refresh and check again",
                "exception_module_messages" => "",
            ],
            $index . '_29' => [
                "exception_code"            => "CCAM29",
    ...
    public function saveAdminLabels()
    {
        ...
        $labelsValue = [
            ...
            $index . '_7'  => [
                "wpay_label_code"   => "AD10",
                "wpay_label_desc"   => "Add Payment Plan",
                "wpay_custom_label" => "",
            ],
            $index . '_8'  => [
                "wpay_label_code"   => "AD12",
                "wpay_label_desc"   => "New Payment Plan",
                "wpay_custom_label" => "",
            ],
            $index . '_9'  => [
                "wpay_label_code"   => "AD13",
                "wpay_label_desc"   => "Cancel",
                "wpay_custom_label" => "",
            ],
            $index . '_10' => [
                "wpay_label_code"   => "AD14",
    ...
    public function saveKlarnaConfig()
    {
        ...
        $subscriptionConfigs = [
            $index . '_0' => [
                "worldpay_klarna_subscription" => "SE",
                "subscription_days"            => "14",
            ],
            $index . '_1' => [
                "worldpay_klarna_subscription" => "NO",
                "subscription_days"            => "14",
            ],
            $index . '_2' => [
                "worldpay_klarna_subscription" => "FI",
                "subscription_days"            => "14",
            ],
            $index . '_3' => [
                "worldpay_klarna_subscription" => "DE",
                "subscription_days"            => "14",
            ],
            $index . '_4' => [
                "worldpay_klarna_subscription" => "AT",
                "subscription_days"            => "14",
            ],
            $index . '_5' => [
                "worldpay_klarna_subscription" => "GB",
                "subscription_days"            => "30",
            ],
            $index . '_6' => [
                "worldpay_klarna_subscription" => "DK",
                "subscription_days"            => "14",
            ],
            $index . '_7' => [
                "worldpay_klarna_subscription" => "US",
                "subscription_days"            => "30",
            ],
            $index . '_8' => [
                "worldpay_klarna_subscription" => "NL",
                "subscription_days"            => "14",
            ],
            $index . '_9' => [
                "worldpay_klarna_subscription" => "CH",
                "subscription_days"            => "14",
            ],
        ];
        $resultArray = [];
