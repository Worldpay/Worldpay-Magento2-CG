...
class DefaultConfigurations implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $this->ccExceptions();
        $this->myAccountAlertCodes();
        $this->adminExceptions();
        $this->miscellaneous();
        $this->checkoutLabels();
        $this->myaccountLabels();
        $this->adminLabels();
    }
    /**
    ...
    /**
     *  Save cc Exception labels
     */
    public function ccExceptions()
    {
     ...
     */
    public function myAccountAlertCodes()
    {
        $index = time();
        $exceptionValues = [
    ...
    /**
     * Save Admin Exceptions
     */
    public function adminExceptions()
    {
        $index = time();
        $exceptionValues = [
     ...
     */
    public function checkoutLabels()
    {
        $index = time();
     ...
     */
    public function myaccountLabels()
    {
        $index = time();
